                ...
                <div className='container'>
                    <div className='py-[35px] grid grid-cols-12 gap-5 gap-y-[30px] border-b border-[#219E64]'>
                        <div className='col-span-12 sm:col-span-6 lg:col-span-4 max-w-[320px]'>
                            ...
                            <p className='text-[18px] text-black pt-5'>EventSphere brings energy, elegance, and unforgettable moments to every celebration, making each event truly special and memorable.</p>
                        </div>
                        ...
                        <div className='col-span-12 sm:col-span-6 lg:col-span-3'>
                            ...
                            <ul className='flex flex-col gap-3'>
                                <li className='text-[18px] text-[#141414] font-medium flex items-center gap-[7px]'><IoIosMail /><span>info@eventsphere.com</span></li>
                                <li className='text-[18px] text-[#141414] font-medium flex items-center gap-[7px]'><FaPhoneVolume /><span>+880 1XXX-XXXXXX</span></li>
                                <li className='text-[18px] text-[#141414] font-medium flex items-center gap-[7px]'><IoLocation /><span>Dhaka, Bangladesh</span></li>
                            </ul>
                        </div>
                    ...
                    <div className='py-7 text-center'>
                        <p className='text-[#141414] text-[16px]'>© 2025 EventSphere. All rights reserved.</p>
                    </div>
                </div>
            </div>
        </>
