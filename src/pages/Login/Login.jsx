                    ...
                    <div className='max-w-[510px] mx-auto px-[25px] md:px-10 py-[30px] md:py-12 bg-white dark:bg-gray-900 shadow-xl rounded-md border border-[#e7e7e798]'>
                        ...
                        <form onSubmit={handleLogin}>
                            <fieldset className="fieldset">
                                ...
                                <a className='pt-2 text-[#141414] dark:text-white text-start text-[14px] hover:underline duration-300 cursor-pointer'>Forgot Password?</a>
                                {/* Button */}
                        ...
                        <p className='text-center text-[#464545] text-[16px] font-medium pt-[22px]'>Don't have an account? <Link state={location.state} className='text-[#219E64] font-semibold' to='/register'>Register</Link></p>
                    </div>
                </div>
            </div>
        </>
