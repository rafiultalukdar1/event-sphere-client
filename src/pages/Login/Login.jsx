        ...
        <>
            <div className='py-[65px] lg:py-[95px]'>
                <div className='container'>
                    <div className='max-w-[510px] mx-auto px-[25px] md:px-10 py-[30px] md:py-12 bg-white shadow-xl rounded-md border border-[#e7e7e798]'>
                        <h2 className='text-[#141414] text-center text-[24px] md:text-[28px] lg:text-[32px] font-semibold'>Login your account</h2>
                        ...
                        <form onSubmit={handleLogin}>
                            <fieldset className="fieldset">
                                ...
                                <a className='pt-2 text-[#141414] text-start text-[14px] hover:underline duration-300 cursor-pointer'>Forgot Password?</a>
                                {/* Button */}
                                <button type="submit" className='py-2 w-full bg-[#219E64] rounded mt-5 text-white text-[18px] font-medium'>Login</button>
                            </fieldset>
                        </form>
                        <div className='divider my-[22px] text-[#141414]'>OR</div>
                        ...
                        <p className='text-center text-[#464545] text-[16px] font-medium pt-[22px]'>Don't have an account? <Link className='text-[#219E64] font-semibold' to='/register'>Register</Link></p>
                    </div>
                </div>
            </div>
        </>
