                ...
                <div className='container'>
                    ...
                    <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-[30px] md:mt-[50px]'>
                        {events.map((event, index) => (
                            <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true, amount: 0.2 }} transition={{ duration: 0.6, delay: index * 0.1 }} key={index} className='relative rounded-xl overflow-hidden group cursor-pointer shadow-sm dark:shadow-white hover:shadow-md transition' >
