        ...
        <>
            <div className='py-[60px] lg:py-[90px] bg-[#FDFDFD] dark:bg-[#1D232A]'>
                <div className='container'>
                    <motion.h2 initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.2 }} transition={{ duration: 0.6 }} className='text-center text-[30px] sm:text-[38px] md:text-[45px] lg:text-[52px] font-bold text-[#141414] dark:text-white'><span>Stay Updated</span></motion.h2>
                    <motion.p initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.2 }} transition={{ duration: 0.6 }} className='text-center text-[16px] md:text-[18px] font-medium text-[#6D7873]'>Subscribe to our newsletter to get updates about new events and community initiatives</motion.p>
