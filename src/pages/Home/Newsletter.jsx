...
const Newsletter = () => {
    return (
        <>
            <div className='py-[60px] lg:py-[90px] bg-[#FDFDFD]'>
                <div className='container'>
                    <h2 className='text-center text-[30px] sm:text-[38px] md:text-[45px] lg:text-[52px] font-bold text-[#141414]'><span>Stay Updated</span></h2>
                    ...
                    <div className='max-w-[730px] mx-auto px-5 md:px-8 pb-8 pt-10 shadow-sm rounded-lg mt-5 lg:mt-[30px]'>
                        <form className="flex flex-col sm:flex-row items-center gap-4 justify-center">
                            <input type="email" placeholder="Enter your email address" className="w-full sm:w-[350px] px-5 py-3 rounded-full  text-[#141414] text-[16px] border border-[#219e648f] focus:border-[#219E64] outline-0" required/>
